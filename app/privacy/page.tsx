        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-10 space-y-8 text-sm">
            ...
            <section className="space-y-3">
              ...
              <ul className="ml-4 list-disc space-y-1 text-muted-foreground">
                <li><strong className="text-foreground">Supabase</strong> (SOC 2 Type II) — database and file storage with row-level security enforced. Only your account can access your data.</li>
                <li><strong className="text-foreground">Vercel</strong> (SOC 2 Type II · ISO 27001) — deployment and edge network with DDoS protection and TLS encryption in transit.</li>
                ...
                <li><strong className="text-foreground">Creem · Lemon Squeezy</strong> — PCI-DSS compliant payment processors. No card data is stored on our systems.</li>
            ...
            <section className="space-y-3">
              ...
              <p className="text-muted-foreground">
                Billing is handled by Creem and/or Lemon Squeezy. We receive confirmation of payment but do not store
                credit card or banking information. Their respective privacy policies govern how payment data is handled.
              </p>
            </section>
