...
const designHighlights = [
  ...
  { icon: <CalendarDays className="h-5 w-5" />, title: "A daily verse", description: "A quiet rotating scripture moment gives the gallery a pause between visual chapters." },
]
