...
export const metadata: Metadata = {
  ...
  description: "Organize freelance receipts automatically. Extract vendors, dates, amounts, and categories into searchable records and clean expense reports.",
