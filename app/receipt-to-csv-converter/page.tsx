...
export const metadata: Metadata = {
  ...
  description: "Convert receipt photos and PDFs into categorized CSV rows with normalized dates, vendors, amounts, and categories.",
...
export default function ReceiptToCsvConverterPage() { return <AudienceLandingPage data={{ eyebrow: "For cleaner records", title: "Convert receipts to CSV without typing every line.", description: "Upload receipt images and PDFs, let AVIntelligence extract the transaction details, then export normalized rows for your spreadsheet or existing workflow.", audience: "record-keeping workflows", examples: ["Vendor name", "Transaction date", "Category"], output: "A normalized CSV with vendor, date, amount, category, and currency columns." }} /> }
