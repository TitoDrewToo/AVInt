          ...
          <div className="relative mx-auto max-w-6xl">
            <div className="max-w-4xl">
              ...
              <div className="mt-9 flex flex-wrap items-center gap-3">
                ...
                <Link href="/pricing" className="inline-flex min-h-11 items-center rounded-xl border border-border/70 px-5 py-3 text-sm font-medium text-muted-foreground hover:border-primary/40 hover:text-foreground">See how it works</Link>
              </div>
            </div>
