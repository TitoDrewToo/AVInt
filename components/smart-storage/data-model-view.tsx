...
type MappingProfile = { slug: string; title: string; description: string | null; status: "draft" | "active"; version: number; previewed_version: number | null; mappings: Array<{ sourceField: string; targetField: string; coercion: string }> }
