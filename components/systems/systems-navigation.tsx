...
import { Activity, Coins, FileWarning, GitCommitHorizontal, LayoutDashboard, Mail, ShieldCheck, Sparkles, type LucideIcon } from "lucide-react"
import { useSystemsAdminAccess } from "@/components/systems/systems-access"

export type SystemsSection = "overview" | "errors" | "inquiries" | "studio" | "economics" | "security" | "status" | "changelog"
...
const internalDestinations = [
  ...
  { href: "/systems/security", label: "Security", Icon: ShieldCheck, active: "security" as const },
