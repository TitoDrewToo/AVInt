...
export type RateLimitBucket = "chat" | "reports" | "delete-account" | "redeem-gift" | "checkout" | "creem-cancel" | "error-capture" | "systems-diagnose" | "systems-security" | "partner-inquiry" | "studio-inquiry" | "upload-cleanup" | "normalization-retry" | "google-drive-connect" | "google-drive-import" | "mcp-ingest" | "mcp-report" | "mcp-export" | "mcp-profile" | "mcp-ingest-global"
