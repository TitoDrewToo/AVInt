...
const expectedTools = [
  "smart_storage.list_files",
  "smart_storage.list_folders",
  "smart_storage.create_folder",
  ...
  "smart_storage.list_virtual_datasets",
  "smart_storage.get_virtual_dataset",
  "smart_storage.save_virtual_dataset",
  "smart_storage.delete_virtual_dataset",
  "smart_storage.list_mapping_profiles",
  "smart_storage.get_mapping_profile",
  "smart_storage.save_mapping_profile",
  "smart_storage.delete_mapping_profile",
  "smart_storage.preview_mapping_profile",
  "smart_storage.activate_mapping_profile",
  "smart_storage.list_relationships",
  "smart_storage.get_relationship",
  "smart_storage.save_relationship",
  "smart_storage.delete_relationship",
  "smart_storage.preview_relationship",
  "smart_storage.activate_relationship",
