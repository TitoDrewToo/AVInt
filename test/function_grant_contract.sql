...
-- authenticated, except for the reviewed is_system_admin() and caller-bound
-- is_firm_admin(uuid) RLS helpers.
...
begin
  ...
  where n.nspname = 'public'
    ...
    and p.oid not in ('public.is_system_admin()'::regprocedure, 'public.is_firm_admin(uuid)'::regprocedure);
